...
public class ProgrammeSpecializationCurriculumCategoryCredit implements Serializable
{
	...
	public void setCreditMaximum(int creditMaximum) {
	...
	public String toString() {
		return "ProgrammeSpecializationCurriculumCategoryCredit [programmeSpecializationModel="
				+ programmeSpecializationModel + ", curriculumCategoryMaster=" + curriculumCategoryMaster + ", credit="
				+ credit + ", creditMaximum=" + creditMaximum + ", courseAllotProcessStatus=" + courseAllotProcessStatus
				+ ", totalCreditCalculationStatus=" + totalCreditCalculationStatus
				+ ", registrationCreditCalculationStatus=" + registrationCreditCalculationStatus
				+ ", cgpaCalculationStatus=" + cgpaCalculationStatus + ", degreeEligibilityStatus="
				+ degreeEligibilityStatus + ", logUserId=" + logUserId + ", logTimeStamp=" + logTimeStamp
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + cgpaCalculationStatus;
		result = prime * result + courseAllotProcessStatus;
		result = prime * result + credit;
		result = prime * result + creditMaximum;
		result = prime * result + ((curriculumCategoryMaster == null) ? 0 : curriculumCategoryMaster.hashCode());
		result = prime * result + degreeEligibilityStatus;
		...
		result = prime * result + registrationCreditCalculationStatus;
		result = prime * result + totalCreditCalculationStatus;
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (cgpaCalculationStatus != other.cgpaCalculationStatus)
			return false;
		if (courseAllotProcessStatus != other.courseAllotProcessStatus)
			return false;
		if (credit != other.credit)
			return false;
		if (creditMaximum != other.creditMaximum)
			return false;
		if (curriculumCategoryMaster == null) {
			if (other.curriculumCategoryMaster != null)
				return false;
		} else if (!curriculumCategoryMaster.equals(other.curriculumCategoryMaster))
			return false;
		if (degreeEligibilityStatus != other.degreeEligibilityStatus)
			return false;
		...
		if (programmeSpecializationModel == null) {
			...
			return false;
		if (registrationCreditCalculationStatus != other.registrationCreditCalculationStatus)
			return false;
		if (totalCreditCalculationStatus != other.totalCreditCalculationStatus)
			return false;
		return true;
	}
