...
public class CommonFunctions 
{
	...
	public void verifyCredentials(String inputString, String storedPassword) 
	{
		if(storedPassword!=null && !storedPassword.isEmpty())
		{
			BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();

			if (! passwordEncoder.matches(inputString, storedPassword))
			{
		...
		{
			throw new BadCredentialsException("Please Reset your password in VTOP");
		}
	...
	{
		CommonFunctions sdf2 = new CommonFunctions();	
		sdf2.doPost(request, response);
	}       


	public static boolean doValidateSlotToTime(HttpSession session,ServletRequest request, 
			ServletResponse response,LocalDateTime endTime) throws ServletException, IOException
	{
